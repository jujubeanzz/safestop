  ...
  return (
    <main style={{
      ...
      <section style={{
        ...
        <p style={{ fontSize: '15px', color: 'rgba(255,251,245,0.88)', lineHeight: '1.7', maxWidth: '300px', margin: '0 auto' }}>
          A free, community-built map of clean washrooms on Indian highways. Rate what you find. Help everyone behind you.
        </p>
      </section>
